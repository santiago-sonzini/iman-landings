#!/bin/bash
# Render de statics-verticales -> PNG (1:1 1080 y 4:5 1350). Mismo mecanismo que
# statics/render.sh: Chrome headless escribe el screenshot, poleamos por PNG
# estable y lo matamos. UI real (../../css/booking.css) + fuentes locales.
...
echo "STATICS-VERTICALES LISTAS — $(ls "$DIR"/renders/*.png 2>/dev/null | wc -l | tr -d ' ') PNGs"
